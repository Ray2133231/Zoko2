...
-----------------------------------
-- تصميم الواجهة الرئيسية الزجاجي --
-----------------------------------
local MainFrame = Instance.new("Frame")
MainFrame.Size = UDim2.new(0, 0, 0, 0)
MainFrame.Position = UDim2.new(0.5, -135, 0.5, -200)
MainFrame.BackgroundColor3 = Color3.fromRGB(20, 5, 5) -- أحمر غامق زجاجي
MainFrame.BackgroundTransparency = 0.45 -- شفافية زجاجية
...
TpFrame.BackgroundColor3 = Color3.fromRGB(20, 5, 5)
...
TpTitle.TextColor3 = Color3.fromRGB(255, 30, 30)
...
BtnAddNewTp.BackgroundColor3 = Color3.fromRGB(150, 20, 20)
...
BtnSaveOrder.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
...
BtnCancelOrder.BackgroundColor3 = Color3.fromRGB(100, 20, 20)
...
TxtOrderMode.TextColor3 = Color3.fromRGB(255, 100, 100)
...
ModalFrame.BackgroundColor3 = Color3.fromRGB(30, 5, 5)
...
ModalInput.BackgroundColor3 = Color3.fromRGB(15, 0, 0)
ModalInput.BackgroundTransparency = 0.4
ModalInput.Text = ""
...
Instance.new("UIStroke", ModalInput).Color = Color3.fromRGB(100, 20, 20)
...
BtnSaveModal.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
...
BtnCancelModal.BackgroundColor3 = Color3.fromRGB(100, 20, 20)
...
ContextMenu.BackgroundColor3 = Color3.fromRGB(25, 5, 5)
...
BtnCtxAutoJoin.BackgroundColor3 = Color3.fromRGB(35, 10, 10)
BtnCtxAutoJoin.BackgroundTransparency = 0.5
...
BtnCtxRename.BackgroundColor3 = Color3.fromRGB(35, 10, 10)
BtnCtxRename.BackgroundTransparency = 0.5
BtnCtxRename.Text = "Rename"
BtnCtxRename.TextColor3 = Color3.fromRGB(255, 150, 50)
...
BtnCtxDelete.BackgroundColor3 = Color3.fromRGB(35, 10, 10)
BtnCtxDelete.BackgroundTransparency = 0.5
...
local function RefreshTpList()
    ...
    for i, item in ipairs(sortedList) do
        ...
        if item.Data.AutoJoin then
            ...
            btn.TextColor3 = Color3.fromRGB(255, 30, 30)
        else
        ...
        if IsReorderMode then
            ...
            DragIcon.ImageColor3 = Color3.fromRGB(255, 50, 50)
...
local function EndDrag()
    if DragInfo.IsDragging then
        ...
        if DragInfo.Placeholder then
            DragInfo.Placeholder.BackgroundTransparency = 0.4
...
ControlFrame.BackgroundColor3 = Color3.fromRGB(20, 5, 5)
...
local BtnCmdTp = CreateControlButton("Teleport", Color3.fromRGB(255, 100, 100))
local BtnCmdBring = CreateControlButton("Bring", Color3.fromRGB(255, 150, 80))
...
local function SetActiveTarget(plr)
    ...
    for userId, card in pairs(TargetCards) do
        ...
        if plr and userId == plr.UserId then
            ...
            if stroke then stroke.Color = Color3.fromRGB(100, 20, 20) stroke.Thickness = 1 end
            card.BackgroundColor3 = Color3.fromRGB(25, 5, 5)
        end
    end
end
...
local function AddTarget(plr)
    ...
    CStroke.Color = Color3.fromRGB(100, 20, 20)
    CStroke.Thickness = 1
...
BtnCloseControl.TextColor3 = Color3.fromRGB(255, 50, 50)
...
SpecFrame.BackgroundColor3 = Color3.fromRGB(20, 5, 5)
SpecFrame.BackgroundTransparency = 0.4
SpecFrame.Visible = false
...
SpecClose.BackgroundColor3 = Color3.fromRGB(150, 30, 30)
SpecClose.Text = "X"
...
local function CreateInputRow(text, defaultValue, parent)
    ...
    InputBox.BackgroundColor3 = Color3.fromRGB(25, 5, 5)
    InputBox.BackgroundTransparency = 0.5
    InputBox.Text = tostring(defaultValue)
    InputBox.TextColor3 = Color3.fromRGB(255, 30, 30)
...
-----------------------------------
-- Aimbot A System مع فحص الجدران (Raycast) والـ TriggerBot
-----------------------------------
...
local function IsVisible(targetPart)
    ...
    -- إذا لم يصطدم بشيء أو اصطدم بالشخص نفسه يعني مكشوف
...
local AimbotLoop = RunService.RenderStepped:Connect(function()
    if Features.Aimbot then
        ...
        if targetHead then
            ...
            -- الإطلاق التلقائي (الـ TriggerBot) شغال دام إنه صار يمسك بس على المكشوف
            ...
            for _, p in pairs(game.Players:GetPlayers()) do
                if p ~= Player and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if not p.Character:FindFirstChild("ZokoESP_Name") then
                        ...
                        txt.TextStrokeColor3 = Color3.fromRGB(255, 30, 30)
...
DevBtn.Text = [[Developed by <font color="rgb(255, 30, 30)"><b>Zoko</b></font>]]
...
RestartBtn.TextColor3 = Color3.fromRGB(255, 30, 30)
...
RestartGlow.Color = Color3.fromRGB(255, 30, 30)
