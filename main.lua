-- [[ Zoko Hub V2 - Advanced Glass Edition ]]
...
MainFrame.Size = UDim2.new(0, 0, 0, 0) -- يبدأ صغير للأنميشن
MainFrame.Position = UDim2.new(0.5, -125, 0.5, -175)
MainFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
MainFrame.BackgroundTransparency = 0.25 -- شفافية فخمة بدون تغبيش الشاشة
MainFrame.Visible = true -- يظهر تلقائياً
...
Stroke.Color = Color3.fromRGB(0, 212, 255) -- لون سماوي لزوكو
Stroke.Thickness = 2
...
-- حاوية الأزرار (لتنظيمها بشكل جميل)
...
-- إخفاء زر الاختفاء في البداية (يظهر فقط مع الطيران)
BtnInvis.Visible = false 
BtnInvis.Size = UDim2.new(0.8, 0, 0, 30) -- أصغر شوي لأنه خيار فرعي
BtnInvis.BackgroundColor3 = Color3.fromRGB(25, 25, 25)

-- 4. ربط الأزرار بالبرمجة
-- God Mode
...
-- 5. زر الحقوق بالأسفل (Developed by Zoko)
